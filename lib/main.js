...
var app = new Vue({
  ...
  methods: {
    ...
    update_solar_system: function () {
      ...
      var earth_coor = {
        "x": earth_xyz.x * draw_sol_scale_factor + solar_center.x,
        "y": earth_xyz.y * draw_sol_scale_factor + solar_center.y
      }
      var mars_coor = {
        "x": mars_xyz.x * draw_sol_scale_factor + solar_center.x,
      ...
      draw_planet(svg, {
        "x": 0,
        "y": 0
      }, draw_sol_scale_factor, solar_center, 10, {
        "text": "Sun",
        "x": 15,
        "y": 10,
        "color": "#FF8700"
